...
{
    public partial class SentimentModel1
    {
        public const string RetrainFilePath =  @"C:\Users\mabdu\Documents\code\btkKursları\SamsunYapayZekaileWebProgramlama\04_store_app\mlnet\data\sample2000binary.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"Text",outputColumnName:@"Text")      
                                    ...
                                    .Append(mlContext.BinaryClassification.Trainers.LbfgsLogisticRegression(new LbfgsLogisticRegressionBinaryTrainer.Options(){L1Regularization=0.174385F,L2Regularization=0.1160918F,LabelColumnName=@"Label",FeatureColumnName=@"Features"}));
